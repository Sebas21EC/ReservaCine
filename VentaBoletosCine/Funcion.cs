...
namespace VentaBoletosCine
{
    class Funcion
    {
        ...
        public bool Recuperar(DBConnection conexionBD, int id_func)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    precio = reader.GetString("precio");
        ...
        public bool Actualizar(DBConnection conexionBD)
        {
            ...
            string commandtxt = "UPDATE funcion SET  hora='" + hora + "', num_sala=" + num_sala + ",id_pelicula=" + id_pelicula + ", precio='" + precio + "' WHERE id_funcion=" + id_funcion+";";
            MySqlCommand command = new MySqlCommand(commandtxt, conexionBD.Connection);
